...
| [gpt-4.1-nano](https://platform.openai.com/docs/models/gpt-4.1-nano) (Recommended & Default)      | OpenAI                   | `model_type='best'`   | Fast (response time in seconds) with high quality responses | Paid (see [here](https://platform.openai.com/docs/pricing) for pricing details) and requires an OpenAI API key with the environment variable `OPENAI_API_KEY`                                |
